          ...
          <div className="row">
            <div className="col-12">
              <div className="contenedor">
                ...
                <div className="item-6 "><button className='btn btn-warning fs-5 botonic'> Registrate!</button></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className="contenedor2">
              ...
              <button className='btn btn-warning fs-5 botonic'>Registrate!</button>
              </div>
